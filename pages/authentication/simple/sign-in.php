                ...
                <div class="row flex-center min-vh-100 py-5">
                    <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a
                        ...
                        <div class="text-center mb-7">
                            <h3 class="text-1000">Fazer Login</h3>
                            ...
                            <div class="col-auto">
                                <div class="form-check mb-0">
                                    <input class="form-check-input" id="basic-checkbox" type="checkbox"
                                        checked="checked" />
                                    <label class="form-check-label mb-0" for="basic-checkbox">Lembrar da senha</label>
                                </div>
                            </div>
                            <div class="col-auto"><a class="fs--1 fw-semi-bold"
                                    href="../../../pages/authentication/simple/forgot-password.html">Esqueci minha
                                    senha?</a></div>
                        </div>
                        <button class="btn btn-primary w-100 mb-3" type="submit" value="Entrar">Login</button>
                        
                        <div class="text-center"><a class="fs--1 fw-bold"
                                href="../../../pages/authentication/simple/sign-up.html">Criar conta</a>
