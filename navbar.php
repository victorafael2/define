        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item border-bottom border-bottom-lg-0"><a
                        class="nav-link lh-1 py-0 fs--1 fw-bold py-3 active" aria-current="page" href="#">Home</a></li>
                                ...
                                <div class="card-body p-0">
                                    <div class="text-center pt-4 pb-3">
                                        <div class="avatar avatar-xl ">
                                            <img class="rounded-circle " src="assets/img/team/avatar-rounded.png"
                                                alt="" />
                                ...
                                <div class="overflow-auto scrollbar" style="height: 5rem;">
                                    <ul class="nav d-flex flex-column mb-2 pb-1">
                                        ...
                                        <li class="nav-item"><a class="nav-link px-3"
                                                href="questionario/diagnosticos.php"><span class="me-2 text-900"
                                ...
                                <div class="card-footer p-0 border-top">
                                    ...
                                    <div class="px-3">
                                        <form class="<?php echo $esconder_ ?>" method="post"
                                            ...
                                            <input class="btn btn-phoenix-danger order-0 d-flex flex-center w-100"
                                                type="submit" value="Encerrar sessão">
                                        </form>
                                    </div>
