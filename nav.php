...
<nav class="navbar bg-white navbar-expand-lg ">
            ...
            <div class="navbar-logo">
              ...
              <a class="navbar-brand me-1 me-sm-3" href="<?php echo $url ?>index.php">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-center"><img src="<?php echo $url ?>assets/img/icons/logo.png" alt="define" width="27" />
    ...
    <?php echo strtoupper(substr($nome_logado, 0, 1)); ?>
                    ...
                    <div class="overflow-auto scrollbar" style="height: 5rem;">
                      <ul class="nav d-flex flex-column mb-2 pb-1">
                        <li class="nav-item"><a class="nav-link px-3" href="<?php echo $url ?>adm/perfil.php"> <span class="me-2 text-900" data-feather="user"></span><span>Profile</span></a></li>
                        <li class="nav-item"><a class="nav-link px-3" href="<?php echo $url ?>adm/questionarios_respondidos.php"><span class="me-2 text-900" data-feather="pie-chart"></span>Meus Relatórios</a></li>
                    ...
                    <div class="card-footer p-0 border-top">
                      ...
                      <hr />
                      <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="pages/authentication/simple/sign-in.php"> <span class="me-2" data-feather="log-out"> </span><form class="<?php echo $esconder_ ?>" method="post"
