                            ...
                            <form id="formulario_questionario">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control" id="faturamento" name="faturamento"
                                            ...
                                            <option value="pequeno_porte">Empresa de pequeno porte (R$ 360.000,01mil a
                                                R$
                                                4,8milhões)</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="radio" id="tipologia-inovacao-3" name="tipologia-inovacao"
                                            value="5">
                                        <label for="tipologia-inovacao-3">Radical: Cria novo produto e processo que
                                            redefine
                                            toda a
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="radio" id="infraestrutura-empresa-4" name="infraestrutura-empresa"
                                            value="3">
                                        <label for="infraestrutura-empresa-4">Não, o projeto será desenvolvido na
                                            empresa
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <label for="equipe-1">Sim, a equipe possui qualificação na área do
                                            projeto</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="equipe-2" name="equipe" value="3">
                                        <label for="equipe-2">Sim, parte da equipe possui qualificação na área do
                                            projeto,
                                            mas
                                    ...
                                    <div>
                                        ...
                                        <label for="equipe-3">Não, precisaremos contratar outra empresa ou terceiros
                                            para
                                            desenvolver o
                                            projeto</label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="checkbox" id="beneficio-inovacao-3" name="beneficio-inovacao[]"
                                            value="5">
                                        <label for="beneficio-inovacao-3">Sim, lei de incentivo fiscal para
                                            inovação</label>
                                    </div>
                                    <div>
