            ...
            <div class="row g-3 ">
                ...
                <div class="row g-0 mb-0 align-items-center">
                    ...
                    <div class="col-7 col-md-6 d-flex justify-content-end">
                        ...
                        <a class="btn btn-primary btn-sm"   href="../adm/questionarios_respondidos.php" ><i class="fa-regular fa-rectangle-list pe-2 fs--2"></i> Meus Relatórios </a>
                    </div>
                </div>
                <div class="row g-3 ">
                                                ...
                                                <div class="modal fade" tabindex="-1" role="dialog" id="youtubeModal">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="ratio ratio-16x9">
                                                                    <iframe class="embed-responsive-item" id="youtubeVideo" width="100%" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="embed-responsive embed-responsive-16by9">
                                                                    <iframe id="youtube-video" class="embed-responsive-item" width="100%" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result_setores)) {
                                                    ...
                                                    $resultado = ($row['icon'] === 'novo') ? $gif_atention : ($row['icon'] === 'icone_verde' ? $gif : $gif);
