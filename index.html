  ...
  <body>
    ...
    <main style="--phoenix-scroll-margin-top: 1.2rem;">
        ...
        <div class="container-small px-0 px-sm-3"><a class="navbar-brand flex-1 flex-lg-grow-0" href="index.html">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-grid d-lg-flex align-items-center">
              ...
              </div><a class="text-500 px-2 d-none d-lg-inline me-2" href="#" data-bs-toggle="modal" data-bs-target="#searchBoxModal"><span data-feather="search" style="height:12px;width:12px;"></span></a><a class="btn btn-link text-900 order-1 order-lg-0 ps-3 me-2" href="pages/authentication/simple/sign-in.html">Entrar</a><a class="btn btn-phoenix-primary order-0" href="pages/authentication/simple/sign-up.html"><span class="fw-bold">Cadastrar</span></a>
            </div>
          </div>
        </div>
      </nav>
            ...
            <div class="modal-body p-0">
              <div class="chat-search-box">
                <div class="form-icon-container">
                  <input class="form-control py-3 form-icon-input rounded-1" type="text" autofocus="autofocus" placeholder="Search People, Groups and Messages" /><span class="fa-solid fa-magnifying-glass fs--1 form-icon"></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container-small">
          <div class="row g-0">
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end"><img class="w-100" src="assets/img/brand2/netflix-n.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-md"><img class="w-100" src="assets/img/brand2/blender.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end border-end-md"><img class="w-100" src="assets/img/brand2/upwork.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-lg-0"><img class="w-100" src="assets/img/brand2/facebook-f.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end border-bottom border-bottom-md-0"><img class="w-100" src="assets/img/brand2/pocket.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-md border-bottom border-bottom-md-0"><img class="w-100" src="assets/img/brand2/mail-bluster-1.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end"><img class="w-100" src="assets/img/brand2/discord.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-sm-5 p-md-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-lg-0"><img class="w-100" src="assets/img/brand2/google-g.png" alt="" /></div>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <div class="position-relative">
        <div class="bg-holder z-index-2 d-none d-md-block" style="background-image:url(assets/img/bg/13.png);background-size:auto;background-position:right;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder z-index-2 d-none d-md-block d-lg-none d-xl-block" style="background-image:url(assets/img/bg/bg-12.png);background-size:auto;background-position:left;">
        </div>
        <!--/.bg-holder-->
                      ...
                      <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                        <div class="col-lg-6 col-xl-5 text-center">
                          <div class="testimonial-avatar-container d-inline-block position-relative">
                            ...
                            <!--/.bg-holder-->
                            <img class="rounded-3 mb-lg-0 opacity-100 position-relative" src="assets/img/team/61.png" width="153" height="153" alt="" />
                          </div>
                        </div>
                      ...
                      <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                        <div class="col-lg-6 col-xl-5 text-center">
                          <div class="testimonial-avatar-container d-inline-block position-relative">
                            ...
                            <!--/.bg-holder-->
                            <img class="rounded-3 mb-lg-0 opacity-100 position-relative" src="assets/img/team/8.png" width="154" alt="" />
                          </div>
                        </div>
                        <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                          <div class="mb-4 light"><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span>
                      ...
                      <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                        <div class="col-lg-6 col-xl-5 text-center">
                          <div class="testimonial-avatar-container d-inline-block position-relative">
                            ...
                            <!--/.bg-holder-->
                            <img class="rounded-3 mb-lg-0 opacity-100 position-relative" src="assets/img/team/35.png" width="154" alt="" />
                          </div>
                        </div>
                        <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                          <div class="mb-4 light"><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span><span class="fa fa-star text-primary"></span>
      ...
      <div class="position-relative">
        ...
        <div class="bg-holder z-index-2 opacity-25" style="background-image:url(assets/img/bg/bg-right-21.png);background-size:auto;background-position:right;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder z-index-2 mt-9 opacity-25" style="background-image:url(assets/img/bg/bg-left-21.png);background-size:auto;background-position:left;">
        </div>
        <!--/.bg-holder-->
      ...
      <section class="bg-white">
        ...
        <div class="container-small position-relative">
          ...
          <div class="row g-3" id="image_gallery" style="min-height: 948px" data-sl-isotope='{"layoutMode":"packery"}'>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/1.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/1.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/2.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/2.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/3.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/3.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/5.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/5.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/4.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/4.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/6.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/6.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/7.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/7.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/9.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/9.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/8.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/8.png" alt="" /></a>
            </div>
            <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!" data-caption="caption" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/10.png"><img class="rounded img-fluid w-100" src="assets/img/gallery/10.png" alt="" /></a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row h-100 g-3 justify-content-center">
              ...
              <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover" src="assets/img/blog/blog-1.png" alt="..." />
                <div class="card-body rounded-top">
                  <div class="d-flex align-items-cente mb-4">
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-eye text-500"></span><span class="text-900 fs--2 ms-1 lh-1">2563</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-heart text-500"></span><span class="text-900 ms-1 fs--2 lh-1">125</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-comment text-500"></span><span class="text-900 ms-1 fs--2 lh-1">125</span></a></div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
              <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover" src="assets/img/blog/blog-2.png" alt="..." />
                <div class="card-body rounded-top">
                  <div class="d-flex align-items-cente mb-4">
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-eye text-500"></span><span class="text-900 fs--2 ms-1 lh-1">1256</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-heart text-500"></span><span class="text-900 ms-1 fs--2 lh-1">325</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-comment text-500"></span><span class="text-900 ms-1 fs--2 lh-1">32</span></a></div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
              <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover" src="assets/img/blog/blog-3.png" alt="..." />
                <div class="card-body rounded-top">
                  <div class="d-flex align-items-cente mb-4">
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-eye text-500"></span><span class="text-900 fs--2 ms-1 lh-1">142</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-heart text-500"></span><span class="text-900 ms-1 fs--2 lh-1">123</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-comment text-500"></span><span class="text-900 ms-1 fs--2 lh-1">22</span></a></div>
                  </div><span class="badge badge-phoenix badge-phoenix-primary mb-2">Marketing</span>
              ...
              <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover" src="assets/img/blog/blog-4.png" alt="..." />
                <div class="card-body rounded-top">
                  <div class="d-flex align-items-cente mb-4">
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-eye text-500"></span><span class="text-900 fs--2 ms-1 lh-1">2563</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-heart text-500"></span><span class="text-900 ms-1 fs--2 lh-1">325</span></a></div>
                    <div class="d-flex align-items-center me-2"><a class="btn-link text-decoration-none" href="#!"><span class="fa-solid fa-comment text-500"></span><span class="text-900 ms-1 fs--2 lh-1">112</span></a></div>
          ...
          <div class="row g-md-4 g-lg-5">
            <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="d-flex flex-column">
                <div class="d-flex align-items-center icon-wrapper shadow-info"><span class="uil uil-phone text-primary light fs-4 z-index-1 ms-2"></span>
                  <div class="flex-1 ms-3"><a class="link-900" href="tel:+871406-7509">(871) 406-7509</a></div>
                </div>
                <div class="d-flex align-items-center icon-wrapper shadow-info"><span class="uil uil-envelope text-primary light fs-4 z-index-1 ms-2"></span>
                  <div class="flex-1 ms-3"><a class="fw-semi-bold text-900" href="mailto:phoenix@email.com">phoenix@email.com</a></div>
                </div>
                <div class="d-flex align-items-center icon-wrapper shadow-info mb-6"><span class="uil uil-map-marker text-primary light fs-4 z-index-1 ms-2"></span>
      ...
      <section id="team">
        <div class="bg-holder z-index-2" style="background-image:url(assets/img/bg/bg-left-17.png);background-size:auto;background-position:left center;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder z-index-2" style="background-image:url(assets/img/bg/bg-right-17.png);background-size:auto;background-position:right center;">
        </div>
        <!--/.bg-holder-->
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="text-center mt-5 position-relative">
                <div class="team-avatar-container d-inline-block position-relative">
                  ...
                  <!--/.bg-holder-->
                  <img class="img-fluid rounded mb-3 position-relative" src="assets/img/team/66.png" alt="..." />
                </div>
                <h4>Alan Casey</h4>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="text-center mt-5 position-relative">
                <div class="team-avatar-container d-inline-block position-relative">
                  ...
                  <!--/.bg-holder-->
                  <img class="img-fluid rounded mb-3 position-relative" src="assets/img/team/67.png" alt="..." />
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="text-center mt-5 position-relative">
                <div class="team-avatar-container d-inline-block position-relative">
                  ...
                  <!--/.bg-holder-->
                  <img class="img-fluid rounded mb-3 position-relative" src="assets/img/team/68.png" alt="..." />
                </div>
                <h4>Narokin Hijita</h4>
                <h6 class="mb-3 fw-semi-bold">CEO, Global Cheat</h6><a href="#!"><span class="fa-brands fa-facebook text-primary me-3"></span></a><a href="#!"><span class="fa-brands fa-twitter text-primary me-3"></span></a><a href="#!"><span class="fa-brands fa-linkedin-in text-primary"></span></a>
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="text-center mt-5 position-relative">
                <div class="team-avatar-container d-inline-block position-relative">
                  ...
                  <!--/.bg-holder-->
                  <img class="img-fluid rounded mb-3 position-relative" src="assets/img/team/69.png" alt="..." />
                </div>
                <h4>Narokin Hijita</h4>
                <h6 class="mb-3 fw-semi-bold">CEO, Global Cheat</h6><a href="#!"><span class="fa-brands fa-facebook text-primary me-3"></span></a><a href="#!"><span class="fa-brands fa-twitter text-primary me-3"></span></a><a href="#!"><span class="fa-brands fa-linkedin-in text-primary"></span></a>
              </div>
