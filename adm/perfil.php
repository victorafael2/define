          ...
          <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-auto">
              <div class="row g-2 g-sm-3">
                ...
                <div class="col-auto">
                  <button class="btn btn-phoenix-secondary redirectToPage" data-href="../questionario.php"><span class="fas fa-clipboard me-2"></span>Questionário</button>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  <div class="border-bottom border-dashed border-300 pb-4">
                    <div class="row align-items-center g-3 g-sm-5 text-center text-sm-start">
                      <div class="col-12 col-sm-auto">
                        ...
                        <label class="cursor-pointer avatar avatar-5xl" for="avatarFile"><img class="rounded-circle" src="<?php echo $url ?>assets/img/team/15.png" alt="" /></label>
                      </div>
                  ...
                  <div class="d-flex flex-between-center pt-4">
                    ...
                    <div class="text-end">
                      ...
                      <h4 class="fs-1 text-1000 mb-0"><?php echo "Há " . $days . " dias<br>";  ?></h4>
                    </div>
                    <div class="text-end">
                      <h6 class="mb-2 text-800">Questionarios feitos</h6>
                      <h4 class="fs-1 text-1000 mb-0"><?php echo $contagem_questionarios ?></h4>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="border-top border-dashed border-300 pt-4">
                    <div class="row flex-between-center mb-2">
                      ...
                      <div class="col-auto"><a class="lh-1" href="mailto:<?php echo $email ?>"><?php echo $email ?></a></div>
                    </div>
                    <div class="row flex-between-center">
                      <div class="col-auto">
                        <h5 class="text-1000 mb-0">Whatapp</h5>
                      </div>
                      <div class="col-auto"><a class="text-800" href="tel:<?php echo $whatsapp ?>"><?php echo $whatsapp ?></a></div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table fs--1 mb-0">
                      ...
                      <tbody class="list" id="profile-review-table-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; L Bands)</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                          <td class="align-middle rating white-space-nowrap fs--2"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-300"></span>
                          </td>
                          <td class="align-middle review pe-7">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">PlayStation 5 DualSense Wireless Controller</a></td>
                          <td class="align-middle rating white-space-nowrap fs--2"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span>
                          </td>
                          <td class="align-middle review pe-7">
                          ...
                          <td class="align-middle status pe-9"><span class="badge badge-phoenix fs--2 badge-phoenix-success">Success<span class="ms-1" data-feather="fas fa-check" style="height:12.8px;width:12.8px;"></span></span></td>
                          <td class="align-middle text-end date white-space-nowrap">
                            <p class="text-700 mb-0">Just now</p>
                          </td>
                          <td class="align-middle white-space-nowrap text-end pe-0">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product pe-3"><a class="fw-semi-bold line-clamp-1" href="#!">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) - Space Gray</a></td>
                          <td class="align-middle rating white-space-nowrap fs--2"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-300"></span>
                          </td>
                          <td class="align-middle review pe-7">
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table table-sm fs--1 mb-0">
                      ...
                      <tbody class="list" id="profile-stores-table-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap ps-0 py-0"><img src="../../../assets/img//brand2/dell.png" alt="" width="53" /></td>
                          <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Dell Technologies</a></td>
                          <td class="color align-middle white-space-nowrap fs--1 text-900"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span>
                          </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap ps-0 py-0"><img src="../../../assets/img//brand2/honda.png" alt="" width="53" /></td>
                          <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Honda</a></td>
                          <td class="color align-middle white-space-nowrap fs--1 text-900"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-300"></span><span class="fa-regular fa-star text-warning-300"></span>
                          </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap ps-0 py-0"><img src="../../../assets/img//brand2/xiaomi.png" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap ps-0 py-0"><img src="../../../assets/img//brand/huawei.png" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap ps-0 py-0"><img src="../../../assets/img//brand2/intel-2.png" alt="" width="53" /></td>
                          <td class="products align-middle"><a class="fw-semi-bold mb-0" href="#!">Intel</a></td>
                          <td class="color align-middle white-space-nowrap fs--1 text-900"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-300"></span>
                          </td>
                ...
                <div class="row g-3 mb-5">
                  ...
                  <div class="col-12 col-lg-6">
                    <div class="row g-2 gy-lg-0">
                      <label class="form-label text-1000 fs-0 ps-1 text-capitalize lh-sm">Date of birth</label>
